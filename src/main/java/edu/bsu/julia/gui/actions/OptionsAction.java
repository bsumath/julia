...
public class OptionsAction extends AbstractAction {
	...
	public OptionsAction(Julia f) {
		super("Options", new ImageIcon(Thread.currentThread()
				.getContextClassLoader().getResource("configure.png")));
		putValue("SHORT_DESCRIPTION", "Options");
		putValue("LONG_DESCRIPTION", "Change the dot size" + "and Axis Trigger");
		parentFrame = f;
	}
