...
public class MainToolBar extends JToolBar {
	...
	void createFileSection() {
		...
		newButton.setToolTipText((String) newAction
		...
		editButton.setToolTipText((String) editSessionAction
				.getValue("SHORT_DESCRIPTION"));
		...
		saveSessionButton.setToolTipText((String) saveSessionAction
				.getValue("SHORT_DESCRIPTION"));
		...
		loadButton.setToolTipText((String) loadSessionAction
				.getValue("SHORT_DESCRIPTION"));
		...
		addFnButton.setToolTipText((String) addFnAction
				.getValue("SHORT_DESCRIPTION"));
	...
	void createViewSection() {
		...
		saveImageButton.setToolTipText((String) saveImageAction
				.getValue("SHORT_DESCRIPTION"));
		...
		printImageButton.setToolTipText((String) printImageAction
				.getValue("SHORT_DESCRIPTION"));
		...
		zoomInButton.setToolTipText((String) zoomInAction
				.getValue("SHORT_DESCRIPTION"));
		...
		zoomOutButton.setToolTipText((String) zoomOutAction
				.getValue("SHORT_DESCRIPTION"));
		...
		resetZoomButton.setToolTipText((String) resetZoomAction
				.getValue("SHORT_DESCRIPTION"));
		...
		addTabButton.setToolTipText((String) addTabAction
				.getValue("SHORT_DESCRIPTION"));
		...
		removeTabButton.setToolTipText((String) removeTabAction
				.getValue("SHORT_DESCRIPTION"));
		removeTabButton.addMouseListener(parentFrame.getStatusBar());
		addSeparator();
		OverviewWindowAction overviewWindowAction = new OverviewWindowAction(
				parentFrame);
		JButton overviewButton = add(overviewWindowAction);
		overviewButton.setFocusable(false);
		overviewButton.setToolTipText((String) overviewWindowAction
				.getValue("SHORT_DESCRIPTION"));
	...
	void createHelpSection() {
		...
		calcButton.setToolTipText((String) complexCalculator
				.getValue("SHORT_DESCRIPTION"));
		...
		optionsButton.setToolTipText((String) optionsAction
				.getValue("SHORT_DESCRIPTION"));
		...
		helpButton.setToolTipText((String) helpAction
				.getValue("SHORT_DESCRIPTION"));
	...
	void createExitSection() {
		...
		exitButton.setToolTipText((String) exitAction
				.getValue("SHORT_DESCRIPTION"));
