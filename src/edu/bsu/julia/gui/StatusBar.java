...
public class StatusBar extends JPanel implements MouseListener, 
	...
	private String defaultString = 
		"Hover over an object to see a description.";
	...
	public void mouseMoved(MouseEvent e) {
		if(e.getSource().getClass().getName().equals
			...
			double xd = (e.getX()*list.getWidth()/panel.getWidth())+list.getX();
			double yd = ((panel.getHeight() - e.getY())
					*list.getHeight()/panel.getHeight())+list.getY();
	...
	public void mouseEntered(MouseEvent e) {
		...
		if(component.getClass().getName().equals(JList.class.getName())) {
		...
		else if(component.getClass().getName().equals(JButton.class.getName())) {
			JButton jButton = (JButton)component;
			helpLabel.setText((String)jButton.getAction().getValue
					("LONG_DESCRIPTION"));
		}
		else if(component.getClass().getName().equals("javax.swing.JToolBar$1")) {
			JButton jButton = (JButton)component;
			helpLabel.setText((String)jButton.getAction().getValue
					("LONG_DESCRIPTION"));
		}
			...
			helpLabel.setText((String)
					(jMenuItem.getAction().getValue("LONG_DESCRIPTION")));
		}
		else if (component.getClass().getName().equals(JMenu.class.getName())) {
			JMenu jMenu = (JMenu) component;
			helpLabel.setText(jMenu.getActionCommand());
		}
		else if (component.getClass().getName().equals(JLabel.class.getName())) {
