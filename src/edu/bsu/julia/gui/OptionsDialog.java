...
public class OptionsDialog extends JDialog implements ActionListener {
	...
	private JSlider dotSizeslider = new JSlider(SwingConstants.HORIZONTAL, 0,
			10, 0);
	...
	public OptionsDialog(Julia f) {
		...
		add(dotSizeslider);
		// Axis checkBox label
		JLabel axisCheckboxLabel = new JLabel("Turn on/off the Axis Bar",
				JLabel.LEFT);
		...
		// Gril checkBox label
		JLabel grilCheckboxLabel = new JLabel("Turn on/off the Grid",
				JLabel.LEFT);
