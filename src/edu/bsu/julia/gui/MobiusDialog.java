 ...
 * 
 * <h3>Description</h3>
 * <p>Creates a dialog box for the function type: (az + b)/(cz + d).  
 * This dialog is used when creating a new cubic function, editing an 
...
public class MobiusDialog extends JDialog implements ActionListener {
	...
	/**
	 * The text field in which the user enters the number which, multiplied 
	 * by i, is the imaginary portion of the function's 'd' coefficient.
	 */
	...
	/**
	 * Builds the dialog for a mobius input function and makes it visible 
	...
	public MobiusDialog(Julia f, int type, MobiusInputFunction fn) {
		...
		else dxField.setText("1");
		dxField.addFocusListener(new TextFieldFocusListener(dxField, parentFrame));
		...
		else dyField.setText("0");
		dyField.addFocusListener(new TextFieldFocusListener(dyField, parentFrame));
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (dialogType == GUIUtil.NEW_DIALOG||dialogType==GUIUtil.CLONE_DIALOG) s.addInputFunction(newFunction);
