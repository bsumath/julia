 ...
 * 
 * <h3>Description</h3>
 * <p>Creates a dialog box for the function create post critical set to input 
 * value for variable t.  This dialog is used when creating a new post critical 
 * set.
 *
 */
public class PostCriticalDialog extends JDialog implements ActionListener{
	...
	public PostCriticalDialog(Julia f) {
		...
		tField.setText("1");
		tField.addFocusListener(new TextFieldFocusListener(tField, parentFrame));
		add(tField);
